  ...
  return (
    <div className={cn("flex items-center gap-3", className)}>
      ...
      <div className="relative flex h-9 w-9 shrink-0 items-center justify-center">
        ...
        <svg viewBox="0 0 24 24" fill="none" className="relative h-5 w-5 text-accent" aria-hidden="true">
          <path
          ...
          />
          <path d="M12 2L12 22M4 8.5L20 8.5M4 15.5L20 15.5" stroke="currentColor" strokeWidth="0.75" opacity="0.4" />
        </svg>
      </div>
      {!compact && (
        <div>
